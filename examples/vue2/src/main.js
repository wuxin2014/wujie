...
import { Scrollbar, Tag, Button, Select, Option, Popover, Dialog, Cascader, DatePicker, Form, FormItem, Row, Col, Input, Table, TableColumn, Autocomplete, Pagination } from 'element-ui';
...
[Scrollbar, Tag, Button, Select, Option, Popover, Dialog, Cascader, DatePicker, Form, FormItem, Row, Col, Input, Table, TableColumn, Autocomplete, Pagination].forEach((element) => Vue.use(element));
